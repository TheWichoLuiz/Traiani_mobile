  ...
  static void showDialog(BuildContext context, {String message}) {
    if (_progressDialog == null) {
      ...
      _progressDialog.style(
          ...
          borderRadius: 5.0,
          backgroundColor: Utils.isLightMode(context)? PsColors.white : PsColors.backgroundColor,
          ...
          progress: 0.0,
          maxProgress: 100.0,
          progressTextStyle: Theme.of(context).textTheme.body1.copyWith(color: PsColors.mainColor),
          messageTextStyle: Theme.of(context).textTheme.body1.copyWith(color: PsColors.mainColor));
    }
  ...
  static void showDownloadDialog(BuildContext context, double progress,
    ...
    if (_progressDialog == null) {
      ...
      _progressDialog.style(
          ...
          progress: progress,
          maxProgress: 100.0,
          progressTextStyle: Theme.of(context).textTheme.body1,
