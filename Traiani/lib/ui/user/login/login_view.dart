      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: FlatButton(
            ...
            child: Text(Utils.getString(context, 'login__sign_in')),
            onPressed: () async {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FlatButton.icon(
        textColor: Colors.white,
        label: Text(Utils.getString(context, 'login__phone_signin')),
        icon: Icon(Icons.phone),
        color: widget.provider.isCheckBoxSelect
            ? PsColors.mainColor
            : PsColors.mainColor,
        onPressed: () async {
...
class __LoginWithFbWidgetState extends State<_LoginWithFbWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      width: double.infinity,
      child: FlatButton.icon(
          label: Text(Utils.getString(context, 'login__fb_signin')),
          icon: Icon(FontAwesome.facebook_official),
          color: widget.userProvider.isCheckBoxSelect == false
...
class __LoginWithGoogleWidgetState extends State<_LoginWithGoogleWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      width: double.infinity,
      child: FlatButton.icon(
        label: Text(Utils.getString(context, 'login__google_signin')),
        icon: Icon(FontAwesome.google),
        color:
            widget.userProvider.isCheckBoxSelect ? Colors.green : Colors.green,
        textColor: Colors.white,
        onPressed: () async {
          if (widget.userProvider.isCheckBoxSelect) {
